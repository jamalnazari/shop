//این حالت برای زمانیست که پروژه ما کوچیکه برای
//  پروژهای بزرگتر منطق توابع و متغییر رو در یک 
// usecart تعریف میکنیم تا بتوان از آن در جاهایی مثل تست یا صفحه ای خاص 
//استفاده کرد
